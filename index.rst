...
#. | `A quantum chemistry calculation distributed among computing facilities with Quantum Package <http://irpf90.ups-tlse.fr/files/JCAD2019AScemama.pdf>`__
   | 10/10/2019 Journées des Calculs et de données, Toulouse. `Watch video <https://prismes.univ-toulouse.fr/player.php?code=9rW78559&width=100%&height=100%>`__
